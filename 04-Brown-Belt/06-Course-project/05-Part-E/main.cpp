...
private:
    ...
    public:
        ...
        friend ostream& operator<<(ostream& output, const Stops::StopInfo &stop);
...
public:
    ...
    friend ostream& operator<<(ostream& s_out, const Stops& stops);
    friend ostream& operator<<(ostream& output, const Stops::StopInfo &stop);
    ...
    double find_real_distance(const string &stop_name_from, const string &stop_name_to) const {
    ...
    double find_geo_distance(const string &stop_name_from, const string &stop_name_to) const {
...
private:
    ...
    vector<string_view> vertex_indeces;
    unordered_map<string_view, VertexId> terminal_vertex_indeces;
    unordered_map<Graph::EdgeId, EdgeInfo> edge_info;
    
    unique_ptr<Graph::DirectedWeightedGraph<double>> p_edges;
